...
const Slide = ({ banner, title, description }) => {
  return (
    <div className="w-full lg:h-[38rem] flex lg:flex-row flex-col items-center bg-secondary/10 lg:px-16 pt-5 md:pt-10">
      {/* text content */}
      <div className="lg:w-1/2 flex flex-col gap-3 md:gap-10 px-3 md:px-0">
        ...
        <p className="text-sm md:text-base tracking-wide font-light">{description}.</p>
        <Link to={`/allServices`}>
